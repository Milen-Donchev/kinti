...
const privacyDocuments: Record<Language, LegalDocument> = {
  bg: {
    ...
    description:
      'Как Levko събира, използва и пази информацията, нужна за управление на лични разходи.',
    updatedAt: 'Последна актуализация: 25 юли 2026 г.',
    sections: [
      {
        title: 'Каква информация събираме',
        body: [
          'Когато създадеш акаунт или влезеш с Google, Levko може да получи имейл адрес, име и профилна снимка от доставчика на идентичност.',
      ...
      },
      {
        title: 'Доставчици',
        body: [
          'Levko използва Supabase за authentication и база данни, Google за Google sign-in и cloud инфраструктура за хостинг на приложението.',
...
const termsDocuments: Record<Language, LegalDocument> = {
  bg: {
    ...
    description:
      'Основните правила за използване на Levko като личен инструмент за управление на разходи.',
    updatedAt: 'Последна актуализация: 25 юли 2026 г.',
    sections: [
      {
        title: 'За какво служи Levko',
        body: [
          'Levko е инструмент за лично проследяване на разходи, абонаменти, сметки и еднократни плащания.',
      ...
      },
      {
        ...
        body: [
          'Стремим се Levko да бъде достъпен и стабилен, но не гарантираме непрекъсната работа без прекъсвания.',
      ...
      },
      {
        ...
        body: [
          'Levko, включително дизайнът, текстовете, визуалните материали, интерфейсът и оригиналният код, са създадени от Milen Donchev през 2026 година, освен ако изрично не е посочено друго.',
